...
const inputTxt = document.getElementById("task-adder__input");
const btnAdd = document.getElementById("task-adder__btn-add");
...
function addTaskToUI(task) {
  let newTask = `
      <div class="current-tasks__task" data-id="${task.id}">
        <p class="task__text">${task.text}</p>
        <div class="task__btn-delete"></div>
      </div>
    `;
